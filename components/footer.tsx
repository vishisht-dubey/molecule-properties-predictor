...
export default function Footer() {
    ...
    return <footer>
        <div className="w-full  bg-slate-100 dark:bg-black fixed bottom-0">
            ...
            <p className="text-center text-base mb-4">Website Created and Developed By <a href="/team" className="font-semibold text-blue-500" target="_blank">Team</a> under the guidance of <a href="https://www.iitbhu.ac.in/dept/phe/people/rajnishphe" className="font-semibold text-blue-500" target="_blank">Prof. Dr. Rajnish</a> IIT-BHU, Varanasi 221005</p>
        </div>
    </footer>
}